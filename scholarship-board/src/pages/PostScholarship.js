...
const PostScholarship = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.host_country.trim()) newErrors.host_country = 'Host country is required.';
    if (!formData.benefits.trim()) newErrors.benefits = 'Benefits are required.';
    if (!formData.eligibility.trim()) newErrors.eligibility = 'Eligibility criteria are required.';
    if (!formData.degree_level.trim()) newErrors.degree_level = 'Degree level is required.';
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-md rounded-lg">
      <h2 className="text-2xl font-bold mb-6 text-center">Post a Scholarship</h2>
      {successMessage && (
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          ...
          />
          {errors.host_country && <p className="text-red-500 text-xs mt-1">{errors.host_country}</p>}
        </div>
